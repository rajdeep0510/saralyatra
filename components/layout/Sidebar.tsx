...
import { Landmark, Compass, Home, Heart } from "lucide-react";
...
export default function Sidebar({ activeTab, setActiveTab, currentLang }: SidebarProps) {
  const t = translations[currentLang] || translations.en;

  const menuItems = [
    { id: "explore", label: t.exploreTab || "Explore", icon: Landmark },
    { id: "planner", label: t.plannerTab || "Planner", icon: Compass },
    { id: "homestays", label: t.homestaysTab || "Homestays", icon: Home },
  ];
